 ...
 */
public class AnnotationFormatterImpl implements AnnotationFormatter, Serializable {
    ...
    public String formatAnnotation(Annotation annotation) {
        return String.format(FORMAT,
                ...
                annotation.getW(),
                annotation.getH(),
                Strings.nullToEmpty(annotation.getTr_arabic()),
                Strings.nullToEmpty(annotation.getTr_latin()),
                Strings.nullToEmpty(annotation.getTr_latin2()),
                Strings.nullToEmpty(annotation.getDescription())
        );
    }
    ...
    public Annotation parseLine(String fileId, String line) {
        ...
        final String annotationId = getStringFromLine(line, ANNOTATION_ID_INDICES);
        ...
        final String tr_arabic = getStringFromLine(line, TR_ARABIC_INDICES);
        final String tr_latin = getStringFromLine(line, TR_LATIN_INDICES);
        final String tr_latin2 = getStringFromLine(line, TR_LATIN2_INDICES);
        final String description = getStringFromLine(line, DESCRIPTION_INDICES);
    ...
    private String getStringFromLine(String line, Pair<Integer, Integer> indices) {
    ...
    private int getIntegerFromLine(String line, Pair<Integer, Integer> indices) {
        final String string = getStringFromLine(line, indices);
